        ...
        <div className="flex h-16 items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-neutral-400 font-medium -mt-1">Solana Stablecoins</span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Badge
              variant="secondary"
              className="hidden sm:flex items-center gap-1.5 bg-neutral-800/50 text-neutral-300 border-neutral-700/50"
            >
